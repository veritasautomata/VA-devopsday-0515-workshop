...
```sh
git clon https://github.com/veritasautomata/VA-devopsday-0515-workshop/
...
- Workshop repo: `https://github.com/veritasautomata/VA-devopsday-0515-workshop/` — has all files, README with the deeper version
